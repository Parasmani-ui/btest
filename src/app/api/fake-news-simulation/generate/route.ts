...
import { FAKE_NEWS_SIMULATION_PROMPT } from '@/utils/prompts';
...
export async function POST(request: NextRequest) {
  try {
    console.log('Starting fake news simulation generation...');
    ...
    console.error('Error in fake news simulation generation:', error);
