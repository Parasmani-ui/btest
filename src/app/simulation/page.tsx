  ...
  return (
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="w-64 bg-gray-800 flex flex-col p-4 border-r border-gray-700">
        ...
        <a 
          href="/"
          className="group mb-4 w-full py-2 px-4 bg-gray-700 text-white rounded-lg hover:bg-gray-600 flex items-center justify-center transition"
        >
      ...
      <div className="flex-1 overflow-auto">
        ...
        {/* <div className="w-full px-6 py-4">  */}
          ...
          {/* Description */}
          <div className="bg-gray-800 p-5 rounded-lg shadow-lg mb-4 transition hover:translate-y-[-5px]">
          ...
          <div className="bg-gray-800 p-5 rounded-lg shadow-lg transition hover:translate-y-[-5px]">
